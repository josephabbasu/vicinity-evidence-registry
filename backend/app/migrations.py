...
STUDY_COLUMNS = {
    ...
    "transferability_population": "VARCHAR(80) DEFAULT 'Needs verification'",
    "transferability_feasibility": "VARCHAR(80) DEFAULT 'Needs verification'",
    "transferability_overall": "VARCHAR(40) DEFAULT 'Needs verification'",
